...
#*******************************************************************************************************
class sEditTwoStringsDialog(wx.Dialog):
...
class sFilePrefsDialogBase(wx.Dialog):
    ...
    def OnActivate(self, event):
        ...
        if sel == -1:
            return
        d = sEditTwoStringsDialog(self, self.dlabel1, self.dlabel2, 'Edit ' + self.dtitle)
    ...
    def OnAdd(self, event):
        d = sEditTwoStringsDialog(self, self.dlabel1, self.dlabel2, 'Add ' + self.dtitle)
        answer = d.ShowModal()
        v = d.GetValues()
        d.Destroy()
...
class sFilePrefsDialog(sFilePrefsDialogBase):
    def __init__(self, parent):
        sFilePrefsDialogBase.__init__(self, parent, 'Edit Wildcard')
...
class sReplaceTableDialog(sFilePrefsDialogBase):
    def __init__(self, parent):
        sFilePrefsDialogBase.__init__(self, parent, 'Windows Shortcut Replace Table')
