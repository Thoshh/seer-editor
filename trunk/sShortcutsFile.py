...
import sPrefsFile
from sShortcuts import BuildShortcutString, GetKeycodeStringFromShortcut, MatchControl, MatchShift, MatchAlt, MatchMeta
...
def ReadSTCShortcuts(filename):
    ...
    while x < l:
        ...
        shortcuttext = sPrefsFile.ExtractPreferenceFromText(text, progshortcutlist[x])

        Keycode = sPrefsFile.ExtractPreferenceFromText(shortcuttext, "keycode")

        modifiers = sPrefsFile.ExtractPreferenceFromText(shortcuttext, "mod")
...
def ReadShortcuts(filename, getIgnoreString = 1):
    ...
    if getIgnoreString:
        ...
        ignorestring = sPrefsFile.ExtractPreferenceFromText(text, "ignore")
        ...
        while len(line) > 0:
            ...
            if (s > -1) and (e > -1):
                ...
                Keycode = sPrefsFile.ExtractPreferenceFromText(line, "keycode")

                modifiers = sPrefsFile.ExtractPreferenceFromText(line, "mod")
