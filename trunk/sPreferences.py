...
class sPreferences:
    ...
    def __init__(self, platform_is_windows, programdirectory = ""):
        ...
        #File Types
        self.extensions = {0: 'py,pyw', 1: 'c,cc,cpp,cxx,h,hh,hpp,hxx', 2: 'htm,shtm,html,shtml,xml', 3: 'txt,dat,log', 4: 'rb,rbw', 5: 'f,for'}
        ...
        if self.platform_is_windows:
            self.txtPromptStyleDictionary[0] = "fore:#000000,back:#FFFFFF,size:8,face:MS Sans Serif"
        # line number (margin)
    ...
    def resetjust(self, target):
        defaults = sPreferences(self.platform_is_windows, self.programdirectory)
