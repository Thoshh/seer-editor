...
class sColorPanel(wx.Panel):
    ...
    def OnScroll(self, event):
        ...
        if i == self.ID_RED:
            ...
            if len(text) != 7:
                sScrolledMessageDialog.ShowMessage(self, ("The text box above should be formatted as follows:\n#0033AA,\nStart with the # character, followed by 6 characters which can be 0-9 or a-f.\nSeer will ignore any changes to the color until this is fixed."), "Error")
                return
        ...
        if self.txtColor.IsEditable():
            ...
            if (v[0] == "#") and (len(v) == 7):
                ...
                try:
                    ...
                    sScrolledMessageDialog.ShowMessage(self, ("Bad Color Data.  Should be in the form #00A3F4\nUse only digits 0-9, characters A-F"), "Error")
            else:
                self.red.Enable(False)
                self.green.Enable(False)
                self.blue.Enable(False)
...
class sSeparatorDialog(wx.Dialog):
    ...
    def __init__(self, parent, title):
        ...
        self.fgPanel = sColorPanel(self, -1, wx.Point(10, 200), wx.Size(400, 350), True)

        self.bgPanel = sColorPanel(self, -1, wx.Point(220, 200), wx.Size(400, 350), False)
...
class sSimpleStyleDialog(wx.Dialog):
    ...
    def __init__(self, parent, id, title, stylestring, defaultstylestring, ChangeSpec = 0):
        ...
        try:
            ...
            sScrolledMessageDialog.ShowMessage(self, ("Current Font (" + self.font + ") is not in the fontlist.  \nSetting to the default."), "Error")
            self.font = 'courier'
            self.size = '12'
            try:
                self.FontList.index(self.font)
            ...
            try:
                ...
                sScrolledMessageDialog.ShowMessage(self, ("Something is quite screwy with fonts on your system.\nNo font will be selected.\nSelect one from the list manually."), "Error")
        ...
        self.fgPanel = sColorPanel(self, id, wx.Point(10, 200), wx.Size(400, 225), True)
        self.fgPanel.SetValue(self.foreground)
        self.bgPanel = sColorPanel(self, id, wx.Point(220, 200), wx.Size(400, 225), False)
...
class sStyleDialog(wx.Dialog):
    ...
    def __init__(self, parent, id, title, isPrompt = False):
        ...
        self.fgPanel = sColorPanel(self, id, wx.DefaultPosition, wx.Size(400, 225), True)
        self.bgPanel = sColorPanel(self, id, wx.DefaultPosition, wx.Size(400, 225), False)
