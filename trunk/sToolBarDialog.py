...
class sToolBarDialog(wx.Dialog):
    ...
    def OnbtnChange16(self, event):
        ...
        if answer == wx.ID_OK:
            ...
            newname = "<Default>"
            if i == 1:
                dlg = sFileDialog.FileDialog(self.parent, "Open", "PNG (*.png)|*.png")
    ...
    def OnbtnSave(self, event):
        ...
        msg = "Succesfully wrote to:\n"  + toolbarfile + "\nand updated the current instance of Seer."
        ...
        try:
            ...
            return
        if self.parent.prefs.enablefeedback:
            sScrolledMessageDialog.ShowMessage(self, msg, "Saved ToolBar")
