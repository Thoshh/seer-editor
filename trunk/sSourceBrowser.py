...
class sTree(wx.TreeCtrl):
    ...
    def OnItemActivated(self, event):
        ...
        try:
            ...
            sScrolledMessageDialog.ShowMessage(self.parent, 'Error Activating Item', 'Source Browser Error')

class sSourceBrowserPanel(wx.Panel):
    def __init__(self, parent, id, Position, Index):
        ...
        self.classtree = sTree(self, -1, wx.Point(0, 0), wx.Size(400, 200), wx.TR_DEFAULT_STYLE|wx.TR_HIDE_ROOT, self.parent)
        ...
        if not self.Browse():
            self.mixed = 1
            msg = 'This document is mixed.  It uses tabs and spaces for indentation.\nSeer may not be able to correctly display the class browser.  Please use "Edit:Whitespace:Clean Up Indentation" to fix this.'
            sScrolledMessageDialog.ShowMessage(self, msg, "Check Indentation Results")
