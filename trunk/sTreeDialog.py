...
class sTreeDialog(wx.Dialog):
    ...
    def __init__(self, parent, title, rootstring, targetfile, targetstyle, dialogsizefile, bitmapfile, BuildTreeFromString, WriteBranch):
        ...
        self.datatree = sTree(self, -1, bitmapfile, targetstyle, wx.Point(0, 0), wx.Size(500, 350), wx.TR_DEFAULT_STYLE | wx.TR_EDIT_LABELS)
    ...
    def initialize(self):
        if os.path.exists(self.targetfile):
            try:
                ...
                sScrolledMessageDialog.ShowMessage(self.parent, ('File Error.\n"'+self.targetfile+'"\n'), "Error")
    ...
    def OnbtnRemove(self, event):
        ...
        try:
            ...
            sScrolledMessageDialog.ShowMessage(self, ("Something went wrong trying to remove that item....\nWhat's it called....\nOh yes: " + t + "\n"), "Error")
            return
