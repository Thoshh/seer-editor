...
class sOpenImportedModuleDialog(sSingleChoiceDialog):
    def __init__(self, parent, modulelist, point=wx.DefaultPosition, size=(250, 300)):
        sSingleChoiceDialog.__init__(self, parent, "Open Imported Module", modulelist, point, size)
    ...
    def OnbtnCancel(self, event):
        self.OnCloseW(None)
        sSingleChoiceDialog.OnbtnCancel(self, event)

    def OnbtnOk(self, event):
        self.OnCloseW(None)
        sSingleChoiceDialog.OnbtnOk(self, event)
