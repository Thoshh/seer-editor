...
class sSourceBrowserGoToDialog(sSingleChoiceDialog):

    def __init__(self, parent, Document, matches, positions):
        sSingleChoiceDialog.__init__(self, parent, 'Source Browser Go To', matches, False, SetSizer=False)
...
def SourceBrowserGoTo(frame, Document):
    ...
    d = sSourceBrowserGoToDialog(frame, Document, matches, positions)
    answer = d.ShowModal()
    d.Destroy()
