...
"""
convert_skeys.py
Convert key codes of Seer Shortcuts
...
And then prompts for conversion of each shortcuts file of Seer.
...
sFiles=["shortcuts.dat","stcshortcuts.dat","sscript.shortcuts.dat"]
userpreferencesdirectory = os.environ["APPDATA"].replace("\\", "/") +'/seer/'
